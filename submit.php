	...
	<body>
		...
		<div class="center" id="wordcloud">
			...
			//	var_dump($final);
				...
				$newarraycount = 0;
				// newarray is an array with all instance of words
				$newarray = array();
				...
				$filtered = filter_stopwords($final, $stopwords);
				$_SESSION['allWords'] = $filtered;
		...
		<div id="inputarea">
			...
			<form action="submit2.php" method="get"> 
				...
				<div class="floatright">
					...
					<button id="shareWithFacebook" class="fb-share-button sharebutton" data-layout="button"></button>
